...
namespace Cheeteye.iOS.Renderer
{
    public class CustomFrameRenderer : VisualElementRenderer<CustomFrame>
    {
        ...
        protected override void OnElementPropertyChanged(object sender, System.ComponentModel.PropertyChangedEventArgs e)
        {
            ...
            //if (e.PropertyName == "CornerRadius" || e.PropertyName == "StrokeThickness" || e.PropertyName == "OutlineColor"
            //    || e.PropertyName == "BackgroundColor" || e.PropertyName == "StartColor" || e.PropertyName == "EndColor"
            //    || e.PropertyName == "HasShadow" || e.PropertyName == "ShadowColor")
            //{
            //ApplyStyle();
            SetGradientColor();
            //}
