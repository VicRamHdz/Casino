...
namespace Cheeteye.Controls
{
    public class CustomTabPage : Grid
    {
        ...
        public static readonly BindableProperty ButtonsPositionProperty = BindableProperty.Create(nameof(ButtonsPosition), typeof(ButtonsPosition), typeof(CustomTabPage), ButtonsPosition.Up, BindingMode.OneWay);
        ...
        protected override void OnPropertyChanged(string propertyName = null)
        {
            ...
            if (propertyName == ButtonsPositionProperty.PropertyName)
            {
                if (ButtonsPosition == ButtonsPosition.Up)
                {
                    ...
                    linePosition = 1;
                    tabsPosition = 2;
                    RowDefinitions.Add(new RowDefinition() { Height = TitleHeight });
        ...
        private async void AddPages()
        {
            ...
            foreach (var tabs in Pages)
            {
                ...
                CustomFrame tabButton = new CustomFrame() { HasShadow = false, StartColor = StartBackgroundColor, EndColor = EndBackgroundColor, Padding = 2 };
            ...
            BoxView underline = new BoxView() { HeightRequest = 1, Color = FullUnderlineColor, HorizontalOptions = LayoutOptions.FillAndExpand, VerticalOptions = LayoutOptions.FillAndExpand };
